...
DEFAULT_EXCLUDE_PATTERNS = [
    ...
    "out/",
    "output/",
    # Rust / Cargo / Tauri build outputs (recreatable, can be huge — must
    # never go to provider). target/ is the canonical Cargo output dir.
    "target/",
    "**/target/",
    ...
    "vendor/",
    "Godeps/",
    # SQLite databases, dashboard runtime files (per-user).
    "*.db",
    "*.db-wal",
    "*.db-shm",
    # Tauri AppImage / .deb bundles (regenerated by `bash app/tauri/build.sh`).
    "**/bundle/",
    # System / OS clutter.
    ".Trash-*/",
    "lost+found/",
...
HARD_EXCLUDE_PATTERNS = [
    ...
    ".claude/worktrees/",
    # Auto-generated by packaging/build-deb.sh — staged tree under
    # packaging/deb/opt/ascendo/ and the /usr/local/bin shims. DEBIAN/*
    # templates ARE tracked (they're the .deb's control + postinst/
    # prerm/postrm scripts). Sesja 57 — these add ~800 stale files to
