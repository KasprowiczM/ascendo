...
install -m 0644 "${SCRIPT_DIR}/share/icons/hicolor/scalable/apps/ascendo-web.svg" \
    "${ICON_DIR}/ascendo-web.svg"
install -m 0644 "${SCRIPT_DIR}/share/icons/hicolor/scalable/apps/ascendo-desktop.svg" \
    "${ICON_DIR}/ascendo-desktop.svg"
install -m 0644 "${SCRIPT_DIR}/share/applications/ascendo-web.desktop" \
    "${APPS_DIR}/ascendo-web.desktop"
...
install -m 0755 "${SCRIPT_DIR}/share/bin/ascendo-web" \
    "${BIN_DIR}/ascendo-web"
install -m 0755 "${SCRIPT_DIR}/share/bin/ascendo-desktop" \
    "${BIN_DIR}/ascendo-desktop"
# Drop the old desktop file if it lingers
