...
if command -v iconutil >/dev/null 2>&1; then
  ...
  mkdir -p "$ICONSET"
  $IM -background none "$SVG" -resize 16x16     "$ICONSET/icon_16x16.png"
  $IM -background none "$SVG" -resize 32x32     "$ICONSET/icon_16x16@2x.png"
  $IM -background none "$SVG" -resize 32x32     "$ICONSET/icon_32x32.png"
  $IM -background none "$SVG" -resize 64x64     "$ICONSET/icon_32x32@2x.png"
  $IM -background none "$SVG" -resize 128x128   "$ICONSET/icon_128x128.png"
  $IM -background none "$SVG" -resize 256x256   "$ICONSET/icon_128x128@2x.png"
  $IM -background none "$SVG" -resize 256x256   "$ICONSET/icon_256x256.png"
  $IM -background none "$SVG" -resize 512x512   "$ICONSET/icon_256x256@2x.png"
  $IM -background none "$SVG" -resize 512x512   "$ICONSET/icon_512x512.png"
  $IM -background none "$SVG" -resize 1024x1024 "$ICONSET/icon_512x512@2x.png"
