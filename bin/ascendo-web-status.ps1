# bin/ascendo-web-status.ps1 -- convenience wrapper for `ascendo web status`.
...
Write-Host "==> ascendo web status" -ForegroundColor Cyan
& $python -m ascendo web status @Args
exit $LASTEXITCODE
